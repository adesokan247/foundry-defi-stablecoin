...
// replace getHealthyFactor with getAccountInformation
...
contract DSCEngineTest is Test {
    ...
    function testGetUsdValue() public view {
        ...
        // 15e18 * 3,498.86 2000/ETH = 30,000e18;
    ...
    function testDepositedCollateralZero() public {
        vm.startPrank(USER);
    ...
    modifier depositedCollateral() {
        vm.startPrank(USER);
        // Approve the collateral so that it can be deposited
        ERC20Mock(weth).approve(address(dsce), AMOUNT_COLLATERAL);

        // Deposit the approved collateral into the DSCEngine
    ...
    ///////////////////////////////////////
    modifier mint(uint256 mintAmount) {
        vm.startPrank(USER);
        dsce.mintDsc(uint256(mintAmount));
        vm.stopPrank();
        _;
    }

    function testdepositCollateralAndMintDsc() public depositedCollateral mint(4e18) {
        (uint256 totalDscMinted, uint256 collateralValueInUsd) = dsce.getAccountInformation(USER);

        uint256 expectedDepositAmount = dsce.getTokenAmountFromUsd(weth, collateralValueInUsd); 
        assertEq(AMOUNT_COLLATERAL, expectedDepositAmount);

        uint256 expectedTotalDscMinted = 4e18;
        assertEq(totalDscMinted, expectedTotalDscMinted);
    ...
    function testRevertsIfMintedDscBreaksHealthFactor() public {
        ...
        uint256 expectedHealthFactor = 
            dsce.getHealthFactor(dsce.getUsdValue(weth, AMOUNT_COLLATERAL), amountToMint);
    ...
    function testburnMoreThanWhatMinted()  public{
        vm.prank(USER);
        vm.expectRevert();
        dsce.burnDsc(5e18);
    ...
    function testProperlyReportsHealthFactor() public depositedCollateralAndMintedDsc {
        ...
        uint256 healthFactor = dsce.calculateHealthFactor(USER);
    ...
    function testHealthFactorCanGoBelowOne() public depositedCollateralAndMintedDsc {
        ...
        uint256 userHealthFactor = dsce.calculateHealthFactor(USER);
    ...
    function testGetCollateralTokenPriceFeed() public  view {
        address priceFeed = dsce.getCollateralTokenPriceFeeds(weth);
